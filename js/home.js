                        ...
                        <div className="col-12 col-sm-6 col-sm-offset-3">
                            <form onSubmit={this.searchHeadlines}>
                                <div className="form-group row">
                                    <input id="mainSearch" className="form-control" type="text" value={this.state.searchTerm} onChange={this.updateSearch} placeholder='Search Headlines (try "Black Panther" or collusion)'/>
                                </div>
